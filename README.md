...
A module to train cell segmentation models using deep learning, as outlined in "Leveraging multi-modal microscopy to optimize deep learning models for cell segementation"  (WD Cameron, AM Bennett, CV Bui, HH Chang, and JV Rocheleau). 
